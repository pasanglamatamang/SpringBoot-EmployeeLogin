...
<div class="goBackButton">
<a class= "back-btn-link-color" href="login"><button class="btn-back"><div class = "loginSignupBack"> &#x2716; Logout</div></button></a>
...
Employee D.B
		...
		<table class="table">
			...
			<tbody>
					<tr>
					    <td><font color="#1A1D1F">${employee.employeeId}</font></td>
						<td><font color="#1A1D1F">${employee.employeeName}</font></td>
						<td><font color="#1A1D1F">${employee.emailId}</font></td>
						<td><font color="#1A1D1F">${employee.password}</font></td>
						<td><font color="#1A1D1F">${employee.salary}</font></td>
